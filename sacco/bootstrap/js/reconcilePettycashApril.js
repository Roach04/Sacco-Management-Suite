$('#reconcile-pettycash-april').on('click', function(event) {

	event.preventDefault();

	//get the summations of the credit.
	var equityMarch = $(this).attr('data-pettycash-april');
...
$(document).ready(function() {
	...
	console.log('Petty Cash April Reconciliation Operational.');
});