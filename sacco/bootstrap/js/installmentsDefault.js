$('.twiffy').find('#modal-default-install').on('click', function(event) {
	...
	** Ajax.
	*/
	$('#modal-installment-default-save').on('click', function() {
		...
		if (installment == '' && bank == '') {
			...
			$.ajax({
				...
				url: 'http://sacco.co.ke/member/maturity/default/store',
				method: 'POST',
				data: {
