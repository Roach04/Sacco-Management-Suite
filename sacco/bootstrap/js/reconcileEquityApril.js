$('#reconcile-equity-april').on('click', function(event) {

	event.preventDefault();

	//get the summations of the credit.
	var equityApril = $(this).attr('data-equity');
	...
	if (bankEstimate == '') {
		...
		//ie bankEstimate from our equityApril ie one month of our coop account in the system.
		var reconcile = equityApril - bankEstimate;
