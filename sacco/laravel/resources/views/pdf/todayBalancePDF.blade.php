...
<body>
	...
	<div style="text-align:center; margin-bottom:10px">
		...
		<p> 
			<strong> 
				Sacco Balance as of <span> {{ $TodayEnd->formatlocalized('%a %d %b %y') }} </span>
			</strong>
		</p>
	...
	<table class="table table-hover table-bordered">
            ...
            <tbody>
                <tr style="background-color:#ffc36d;">
                    <td colspan="8" style="text-align:center">
                        No Cashbook Transaction as of {{ $TodayEnd->formatlocalized('%a %d %b %y') }}
                    </td>
                </tr>
            </tbody>
        @endif
            ...
            <tbody>
                <tr>
                    <td colspan="8" style="background-color:#ffc36d; text-align:center">
                        No Journal Transaction as of {{ $TodayEnd->formatlocalized('%a %d %b %y') }}
                    </td>
                </tr>
            </tbody>
        @endif
        ...
        @else
            <tbody>
                <tr>
                    <td colspan="8" style="background-color:#ffc36d; text-align:center">
                        No Member Deposits as of {{ $TodayEnd->formatlocalized('%a %d %b %y') }}
                    </td>
                </tr>
            </tbody>
        @endif
            ...
            <tbody>
                <tr>
                    <td colspan="8" style="background-color:lightblue; text-align:center">
                        No Loan Disbursements as of {{ $TodayEnd->formatlocalized('%a %d %b %y') }}
                    </td>
                </tr>
            </tbody>
        @endif
        ...
        @else
            <tbody>
                <tr>
                    <td colspan="8" style="background-color:lightblue; text-align:center">
                        No Loan Reimbursements as of {{ $TodayEnd->formatlocalized('%a %d %b %y') }}
                    </td>
                </tr>
            </tbody>
        @endif
