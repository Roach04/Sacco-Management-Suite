         	...
         	<header class="page-header">
	            <div class="container-fluid">
	            	<h2 class="no-margin-bottom">Reconcile April
	            		@if(count($savings) || count($equityendingbalanceMarch) || count($coopAggregate))
	            		...
	            		<div class="col-lg-12">
	              			<div class="card">
	                			...
	                			<div class="card-body">
	                				<form>	
		                				<div class="row">
							            	<label class="col-sm-3 form-control-label">Co - op Bank April</label>
							            	<div class="col-sm-9">
				                    ...
				                    <div class="form-group row">
				                      	<div class="col-sm-4 offset-sm-3">		
				                            <input type="button" data-coop="{{ $coopAggregate }}" class="btn btn-primary" id="reconcile-coop-april" value="Reconcile Account">
				                      	</div>
				                    </div>
	                			...
	                			@else
					            	<div class="container"> 
					            		<p style="text-align:center; color:red; font-size:24px; padding:50px">
					            			There Are No Transactions From Co-op Bank In The Month Of April. 
					            		</p>
					            	</div>
					            @endif
	                		</div>
