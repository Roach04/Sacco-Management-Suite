        ...
        <div class="content-inner">
          	...
          	<header class="page-header">
            	<div class="container-fluid">
              		<h2 class="no-margin-bottom">Prologue</h2>
            	</div>
          	</header>
          	<!-- Page Header-->
              		...
              		<div class="row">
		                ...
		                <div class="statistics col-lg-3 col-12">
		                  	<div class="statistic d-flex align-items-center bg-white has-shadow">
		                    	...
		                    	<div class="text">
		                    		<strong>{{ number_format($sacco, 2) }}</strong><br><small>Sacco Account.</small>
		                    	</div>
		                  	</div>
		                  	<div class="statistic d-flex align-items-center bg-white has-shadow">
		                    	<div class="icon bg-violet">
		                    	...
		                    	<div class="text">
		                    		<strong>{{ number_format($money, 2) }}</strong><br><small>Members' Account.</small>
		                    	</div>
		                  	</div>
		                  	<div class="statistic d-flex align-items-center bg-white has-shadow">
		                    	<div class="icon bg-orange">
		                ...
		                <div class="chart col-lg-3 col-12">
		                  	...
		                  	<div class="bar-chart has-shadow bg-white">
		                    	<div class="title">
		                    		<strong class="text-violet">95%</strong><br><small>Current Server Uptime</small>
		                    	</div>
                      				...
                      				<div class="item">
				                        <div class="row">
				                          	<div class="col-4 date-holder text-right">
				                            	...
				                            	<div class="date"> 
				                            		<span>6:00 am</span><span class="text-info">6 hours ago</span>
				                            	</div>
				                          	</div>
