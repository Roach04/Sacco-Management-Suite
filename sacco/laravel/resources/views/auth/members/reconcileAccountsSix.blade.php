         	...
         	<header class="page-header">
          	...
          	<ul class="breadcrumb">
            	<div class="container-fluid">
              		...
              		<li class="breadcrumb-item active">
	              		6 Months Member Accounts Reconciliation
              		</li>
              		@if(count($accounts))
	                			...
	                			<div class="card-body">
		                				...
		                				<div class="row">
							            	...
							            	<div class="col-sm-9">
						                        <div class="form-group-material">
						                        	<input id="bankEstimateSix" type="number" name="bankEstimateSix" class="input-material">

						                          	<label for="bankEstimateSix" class="label-material"> Provide Bank's Estimate. </label>						                          							                          							                          	
						                        	<br>
						                        	<div id="failure"> </div>
						                        </div>
					                      	</div>
				                    ...
				                    <div class="form-group row">
				                      	<div class="col-sm-4 offset-sm-3">		
				                            <input type="button" class="btn btn-primary" data-cash="{{ $cash }}" id="reconcile-member-six" value="Reconcile Account">
				                      	</div>
				                    </div>
						            ...
						            <div class="row">
							            ...
							            @else
							            	<div class="container" style="text-align:center; color:red; font-size:24px; padding-left:30px"> 
							            		There Are No Member Deposits In The Last 6 Months. 
							            	</div>
							            @endif
						            </div>
	                			</div>
