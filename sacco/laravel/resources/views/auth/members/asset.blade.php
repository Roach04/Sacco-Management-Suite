		                  			...
		                  			<div class="client card">
	                    				...
	                    				<div class="card-body text-center">
					                      	<div class="client-avatar">
					                      		<a class="roles">
					                      			<img style="width:100%; height:100px" src="{{$assets->memberPic}}" alt="..." class="img-fluid rounded-circle">
					                        		<div class="status bg-violet"></div>
					                      		</a>
					                      	</div>
					                      	<div class="client-title">
					                        	<p> {{ $assets->phoneNumber }} </p>
					                        	<p> {{ $assets->emailAddress }} </p>
					                        	{!! Form::open(['route' => ['trashMember', $assets->id], 'method' => 'DELETE' ]) !!}
					                      	...
					                      	<div class="client-info">
						                        <div class="row">
						                          	...
						                          	<div class="col-4"><strong> {{ $assets->idNumber }} </strong><br><small>Id Number</small></div>
						                          	<div class="col-4">
							                          	<strong id="trey"> {{ $assets->accountType }} </strong><br>
							                          	<small>Account</small>
						                          	</div>
						                        </div>
					                      	</div>
	                	...
	                	@else
	                		<div class="contianer">
	                			<p style="color:red; font-size:22px; padding:22px"> 
	                				There are No Members with Asset Accounts at This Time. 
	                			</p>
	                		</div>
	                	@endif
                		<!-- Client Profile -->
