         	...
         	<header class="page-header">
          	...
          	<ul class="breadcrumb">
            	<div class="container-fluid">
              		...
              		<li class="breadcrumb-item active">
	              		3 Months Member Accounts Reconciliation
              		</li>
              		@if(count($accounts))
	          		...
	          		<div class="row">
	            		...
	            		<div class="col-lg-12">
	              			<div class="card">
		                			...
		                			<div class="card-body">
			                				...
			                				<div class="row">
								            	...
								            	<div class="col-sm-9">
							                        <div class="form-group-material">
							                        	<input id="bankEstimateThree" type="number" name="bankEstimateThree" class="input-material">

							                          	<label for="bankEstimateThree" class="label-material"> Provide Bank's Estimate. </label>						                          							                          							                          	
							                        	<br>
							                        	<div id="failure"> </div>
							                        </div>
						                      	</div>
					                    ...
					                    <div class="form-group row">
					                      	<div class="col-sm-4 offset-sm-3">		
					                            <input type="button" class="btn btn-primary" data-cash='{{ $cash }}' id="reconcile-member-three" value="Reconcile Account">
					                      	</div>
					                    </div>
	                			...
	                			@else
					            	<div class="container" style="text-align:center; color:red; font-size:24px; padding:50px"> 
					            		There Are No Member Deposits In The Last 3 Months. 
					            	</div>
					            @endif
	                		</div>
	                	</div>
