        ...
        <div class="content-inner">
         	...
         	<header class="page-header">
	            <div class="container-fluid">
	            	<h2 class="no-margin-bottom">Reconcile April
	            		@if(count($savings))
			            	<div class="pull-right">
			            		<span style="color:grey"> Opening &nbsp; </span> 
				                <span style="color:#ff7676;"> 
				                    {{ number_format($equityendingbalanceMarch, 2) }} 
				                </span>
            	...
            	<div class="container-fluid">
              		...
              		@if(count($savings))
              			<div class="pull-right">
			                ...
			                <span style="color:#DAA520; font:normal 18px book antiqua"> 
			                    {{ number_format($equitySumJournalApril, 0) }} 
			                </span>
			                ...
			                <span style="color:#ffc36d; font:normal 18px book antiqua"> 
			                    {{ number_format($equityDisburse, 2) }} 
			                </span>
	          		...
	          		<div class="row">
	            		...
	            		<div class="col-lg-12">
	              			<div class="card">
				                ...
				                @if(count($savings) || count($equityJournal) || count($depositsEquity) || count($loanequitydisbursements) || count($memberLoanEquityPayments))
	                			<div class="card-body">
	                				<form>	
		                				<div class="row">
							            	<label class="col-sm-3 form-control-label">Equity Bank April</label>
							            	<div class="col-sm-9">
				                    ...
				                    <div class="form-group row">
				                      	<div class="col-sm-4 offset-sm-3">		
				                            <input type="button" data-equity="{{ $equityAggregate }}" class="btn btn-primary" id="reconcile-equity-april" value="Reconcile Account">
				                      	</div>
				                    </div>
	                			...
	                			@else
					            	<div class="container"> 
					            		<p style="text-align:center; color:red; font-size:24px; padding:50px">
					            			There Are No Transactions From Equity Bank In The Month Of April. 
					            		</p>
					            	</div>
					            @endif
	                		</div>
