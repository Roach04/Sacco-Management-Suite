...
<nav class="side-navbar">
    ...
    <ul class="list-unstyled">
        ...
        <li> 
            <a href=" {{ route('loanCalculator') }} ">
                <i class="icon-flask"></i>Loan Calculator
            </a>
        </li>

        <li> 
            <a href=" {{ route('approvedLoans') }} ">
                <i class="icon-padnote"></i>Approved Loans
            </a>
        </li>

        <li> 
            <a href=" {{ route('maturedLoans') }} ">
                <i class="icon-padnote"></i>Matured Loans
            </a>
        </li>
