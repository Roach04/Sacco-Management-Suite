...
<nav class="side-navbar">
    ...
    <ul class="list-unstyled">
        ...
        <li>
            <a href="#balances" aria-expanded="false" data-toggle="collapse"> 
                <i class="icon-clock"></i>Balances 
            </a>
            <ul id="balances" class="collapse list-unstyled">
                <li>
                    <a href="{{ route('balancesYesterday') }}">
                        <i class="icon-screen"> </i>
                        Yesterday.
                    </a>
                </li>
                <li>
                    <a href="{{ route('balancesToday') }}">
