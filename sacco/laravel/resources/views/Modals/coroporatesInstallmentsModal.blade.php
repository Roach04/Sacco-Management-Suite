<!-- Modal -->
<div style="margin-top:60px;" id="coroporatesinstallmentsmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="modal-body">
                            ...
                            <form>                                
                                <div class="form-group-material">
                                    <label class="label-control"> Credit Installment's Account.</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <!-- End of audios. -->
                            <input type="button" class="btn btn-primary" id="modal-installment-save" value="Save Changes">
                        </div>
                    </div>
                </div>
            </div>
